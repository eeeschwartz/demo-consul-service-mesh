...
export DC1_SERVER_PRIVATE_IP=${AWS_PUBLIC_IP:-'10.6.0.2'}
export DC1_SERVER_PUBLIC_IP=${AWS_PUBLIC_IP:-'192.169.7.2'}

export DC2_SERVER_PRIVATE_IP=${AWS_PUBLIC_IP:-'10.5.0.2'}
export DC2_SERVER_PUBLIC_IP=${AWS_PUBLIC_IP:-'192.169.7.4'}
export DC2_RETRY_JOIN_IP=${DC2_RETRY_JOIN_IP:-'192.169.7.2'}
